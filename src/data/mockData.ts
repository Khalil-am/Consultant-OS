...
export const automations: Automation[] = [
  ...
  {
    id: 'auto-diwan',
    name: 'BRD to Userstories (Diwan)',
    description: 'Translates Arabic BRD/user manual content from the Diwan committee management system into professional English user stories and documentation.',
    category: 'BA & Requirements',
    categoryColor: '#0EA5E9',
    inputType: 'Arabic BRD Text',
    outputType: 'English User Manual (Markdown)',
    runCount: 0,
    lastRun: 'Never',
    status: 'Active',
    starred: true,
